...
const Navber = () => {
    ...
    <div className="navbar-start">
        ...
        <div className=" flex  font-bold">
                <img src={img} alt="" />
                <h1 className="text-3xl pb-4">The <span className="text-5xl text-green-500">nature</span>  travel </h1>
            </div>
    </div>
    ...
    <div className="navbar-end">
        {
            ...
            <button onClick={handleLogOut} className=" btn font-bold text-2xl mr-5">sign out</button>
            </>
